module.exports = class Viewport extends Events
{
     ...
     *
     * @emit {click} function click({screen:PIXI.Point, world:PIXi.Point}) in screen and world coordinates - this is called on the up() after a touch/mouse press that doesn't move the threshold pixels
     */
