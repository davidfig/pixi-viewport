...
<div class="navigation">
    ...
    <div class="main">
        <h1 class="page-title" data-filename="node_modules_pixi.js_lib_extract_canvas_CanvasExtract.js.html">Source: node_modules/pixi.js/lib/extract/canvas/CanvasExtract.js</h1>
    ...
    <section>
        <header>
            <div class="header content-size">
                <h2>node_modules/pixi.js/lib/extract/canvas/CanvasExtract.js</h2>
            </div>
        </header>
        <article>
...
//# sourceMappingURL=CanvasExtract.js.map</code></pre>
        </article>
    </section>
